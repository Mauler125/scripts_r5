...
global function InitR5REstablishUserPanel
...
void function InitR5REstablishUserPanel( var panel )
{
	RegisterSignal( "EndShowR5REstablishUserPanel" )
...
{
	Signal( uiGlobal.signalDummy, "EndShowR5REstablishUserPanel" )
	EndSignal( uiGlobal.signalDummy, "EndShowR5REstablishUserPanel" )
