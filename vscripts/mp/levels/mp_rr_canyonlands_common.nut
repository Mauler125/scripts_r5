...
void function SpawnEditorProps()
{
    ...
    // This is a stub to be replaced by code generated by R5Edit, found at:
	// https://github.com/mostlyfireproof/R5Edit

	CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", <9216,27008,4928>, <0,0,0>, true, 8000 )
    CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", <9152,26944,4992>, <0,0,0>, true, 8000 )
    CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", <9152,26944,5248>, <0,-90,0>, true, 8000 )
    CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", <9408,27200,5248>, <0,90,0>, true, 8000 )
    CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_wall_256x256_01.rmdl", <9600,27072,4864>, <0,0,0>, true, 8000 )
    CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_wall_256x256_01.rmdl", <9472,27648,4800>, <0,180,0>, true, 8000 )
    CreateEditorProp( $"mdl/thunderdome/thunderdome_cage_ceiling_256x256_06.rmdl", <9408,27456,4864>, <0,-90,0>, true, 8000 )
}
#endif