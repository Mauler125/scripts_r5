...
void function FixtheMapHoles()
{
	...
	entity squarewall = CreateClientSidePropDynamic( <-2685, 3875, 795>, <90, 45, 0>, FIRINGRANGE_256x256_ASSET )
	entity squarewall2 = CreateClientSidePropDynamic( <2685, 3875, 795>, <-90, -45, 0>, FIRINGRANGE_256x256_ASSET )
	entity squarewall3 = CreateClientSidePropDynamic( <-3620, 2920, 950>, <90, -45, 0>, FIRINGRANGE_256x256_ASSET )
	entity squarewall4 = CreateClientSidePropDynamic( <3620, 2920, 950>, <-90, 45, 0>, FIRINGRANGE_256x256_ASSET )
