...
void function PartyCrasherOnEntitiesDidLoad()
{
    ...
    CreateMapEditorProp( $"mdl/rocks/rock_white_chalk_sand_modular_cap_02.rmdl", < -4883.0000, 1695.0000, 2155.0000 > + startingorg, < -79.0465, 1.8193, 39.1983 >, true, 50000, -1, 1);
    ...
    CreateMapEditorProp( $"mdl/military_base/militaryfort_wall_rooftop_01.rmdl", < 2717.2280, -4190.0260, 511.0005 > + startingorg, < 0.0000, -85.4092, 0.0000 >, true, 50000, -1, 1);
